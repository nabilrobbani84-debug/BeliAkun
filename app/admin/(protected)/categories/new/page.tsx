  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="font-black text-2xl sm:text-3xl text-slate-900">Tambah Kategori Baru</h1>
          <p className="font-semibold text-slate-555 text-xs sm:text-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2.5 rounded-xl border-2 border-slate-900 font-semibold focus:outline-none focus:ring-2 focus:ring-blue-500 bg-slate-50 text-sm"
              placeholder="Layanan OpenAI ChatGPT Premium..."
            />
          </div>
          ...
          <div className="pt-4 border-t-2 border-slate-100 flex justify-end gap-3">
            ...
            >
              <Save className="w-4 h-4" /> {isSubmitting ? 'Menyimpan...' : 'Simpan Kategori'}
            </button>
          </div>
        </form>
      </div>
